                    ...
                    <div class="card shadow-sm">
                        <div class="row">
                            <div class="col-md-6 pe-0">
                                <div
                                    class="card-body border-right border-bottom p-3 h-100"
                                >
                                    <div
                                        class="d-flex flex-row bd-highlight pt-2"
                                    >
                                        <div>
                                            <svg
                                                fill="none"
                                        ...
                                        <div class="ps-3">
                                            <div class="mb-2">
                                                <a
                                                    ...
                                                    class="h5 font-weight-bolder text-dark"
                                                    >Documentation</a
                                                >
                                            </div>
                                            <p class="text-muted small">
                                                ...
                                                you are new to the framework or
                                                have previous experience with
                                                Laravel, we recommend reading
                                        ...
                                        <div class="ps-3">
                                            ...
                                            <p class="text-muted small">
                                                ...
                                                <a
                                                    ...
                                                    >Envoyer</a
                                                >
                                                help you take your projects to
                                                the next level. Pair them with
